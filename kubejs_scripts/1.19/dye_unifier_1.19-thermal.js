...
ServerEvents.recipes(e => {
    ...
    // Uses 1,600 RF per craft (1,800 the custom animal product recipes, 2,000 for the custom mineral recipes)
    ...
    e.recipes.thermal.centrifuge(["2x white_dye", "2x pink_dye", Item.of("bone_meal").withChance(0.2)], "#dyetagger:shells", 1).energy(1800).id("kubejs:centrifuge_shells")
    ...
    e.recipes.thermal.centrifuge(["6x orange_dye"], "pumpkin", 3).energy(1600).id("kubejs:centrifuge_pumpkin")
    e.recipes.thermal.centrifuge(["3x orange_dye"], "carved_pumpkin", 2).energy(1600).id("kubejs:centrifuge_carved_pumpkin")
    e.recipes.thermal.centrifuge(["3x orange_dye", Item.of("charcoal").withChance(0.1)], "#dyetagger:jack_o_lanterns", 3).energy(1600).id("kubejs:centrifuge_jack_o_lanterns")
    ...
    e.recipes.thermal.centrifuge(["2x light_blue_dye"], "#dyetagger:dye_materials/light_blue_smeltables", 1).energy(1600).id("kubejs:extract_smeltable_light_blue_dye")
    ...
    e.recipes.thermal.centrifuge(["2x green_dye", Item.of("2x lime_dye").withChance(0.5)], "#dyetagger:ectoplasm", 4).energy(1800).id("kubejs:centrifuge_ectoplasm")
