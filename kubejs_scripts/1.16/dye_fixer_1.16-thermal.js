...
onEvent("recipes", e => {
    ...
    // Uses 1,600 RF per craft (2,000 for custom recipes that process blocks)
    ...
    e.recipes.thermal.centrifuge(["2x white_dye"], "#dyetagger:dye_materials/white_smeltables", 1).energy(1600).id("kubejs:extract_smeltable_white_dye")

    e.recipes.thermal.centrifuge(["2x white_dye", "2x pink_dye", Item.of("bone_meal").withChance(15)], "#dyetagger:shells", 1).energy(1600).id("kubejs:centrifuge_shells")
    ...
    e.recipes.thermal.centrifuge(["6x orange_dye"], "pumpkin", 3).energy(2000).id("kubejs:centrifuge_pumpkin")
    e.recipes.thermal.centrifuge(["3x orange_dye"], "carved_pumpkin", 2).energy(2000).id("kubejs:centrifuge_carved_pumpkin")
    e.recipes.thermal.centrifuge(["3x orange_dye", Item.of("charcoal").withChance(0.1)], "#dyetagger:jack_o_lanterns", 3).energy(2000).id("kubejs:centrifuge_jack_o_lanterns")

    e.recipes.thermal.centrifuge(["3x orange_dye", Item.of("redstone").withChance(0.75)], "autumnity:redstone_jack_o_lantern", 3).energy(2000).id("kubejs:centrifuge_redstone_jack_o_lantern")
    e.recipes.thermal.centrifuge(["3x orange_dye", Item.of("redstone").withChance(0.75)], "autumnity:large_redstone_jack_o_lantern_slice", 3).energy(2000).id("kubejs:centrifuge_large_redstone_jack_o_lantern")
    ...
    e.recipes.thermal.centrifuge(["9x yellow_dye"], "#dyetagger:dye_materials/yellow_triple", 3).energy(1600).id("kubejs:extract_triple_yellow_dye")
    ...
    e.recipes.thermal.centrifuge(["2x lime_dye"], "#dyetagger:dye_materials/lime_smeltables", 0.2).energy(1600).id("kubejs:extract_smeltable_lime_dye")
    ...
    // Cyan
    e.recipes.thermal.centrifuge(["3x cyan_dye"], "#dyetagger:dye_materials/cyan", 1).energy(1600).id("kubejs:extract_cyan_dye")
    ...
    e.recipes.thermal.centrifuge(["2x cyan_dye"], "#dyetagger:dye_materials/cyan_smeltables", 1).energy(1600).id("kubejs:extract_smeltable_cyan_dye")
    ...
    e.recipes.thermal.centrifuge(["2x purple_dye"], "#dyetagger:dye_materials/purple_smeltables", 1).energy(1600).id("kubejs:extract_smeltable_purple_dye")

    // Blue
    e.recipes.thermal.centrifuge(["3x blue_dye"], "#dyetagger:dye_materials/blue", 1).energy(1600).id("kubejs:extract_blue_dye")
    e.recipes.thermal.centrifuge(["6x blue_dye"], "#dyetagger:dye_materials/blue_double", 1).energy(1600).id("kubejs:extract_double_blue_dye")
    ...
    e.recipes.thermal.centrifuge(["2x brown_dye"], "#dyetagger:dye_materials/brown_smeltables", 1).energy(1600).id("kubejs:extract_smeltable_brown_dye")
    ...
    e.recipes.thermal.centrifuge(["2x green_dye"], "#dyetagger:dye_materials/green_smeltables", 2).energy(1600).id("kubejs:extract_smeltable_green_dye")
